...
Route::group(['middleware' => 'role'], function() {
	...
	Route::get('panel/admin/reports/delete/{id}','AdminController@deleteReport')->where(array('id'=>'[0-9]+'));

	//Mail
	Route::get('panel/admin/mail-template','AdminController@mailTemplates');
	Route::get('panel/admin/mail-template/add','AdminController@addTemplate');
	Route::post('panel/admin/mail-template/store','AdminController@storeTemplate');
	Route::get('panel/admin/mail-template/edit/{id}','AdminController@editTemplate')->where(array('id'=>'[0-9]+'));
	Route::post('panel/admin/mail-template/update','AdminController@updateTemplate');
	Route::get('panel/admin/basic_email','AdminController@basic_email');
	Route::get('panel/admin/mail-send','AdminController@sendMail');
	Route::post('panel/admin/mail-send/submit','AdminController@sendMailSubmit');
	...
	Route::post('panel/admin/pending-images-list','AdminController@pendingImagesList');
	Route::get('panel/admin/pending-images','AdminController@pendingImages');
	Route::get('panel/admin/reject-image/{id}','AdminController@rejectPendingImages');
	Route::get('panel/admin/pending-images/{id}','AdminController@singleImageInfo');
	Route::post('panel/admin/pending-images/reject','AdminController@rejectSingleImage');
	Route::post('panel/admin/pending-images/update','AdminController@updateSingleImageInfo');
	Route::post('panel/admin/pending-images/update-image','AdminController@updateSingleImageInfoImage');
	...
	//Withdrawals
	Route::post('panel/admin/withdrawals-pending-list','AdminController@pendingWithdrawalsList');
	Route::get('panel/admin/withdrawals-pending','AdminController@pendingWithdrawals');
	Route::post('panel/admin/withdrawals-pending/update','AdminController@updatePendingWithdrawals');
	Route::get('panel/admin/withdrawals-rejected','AdminController@rejectedWithdrawals');
	Route::get('panel/admin/withdrawals-paid','AdminController@paidWithdrawals');
