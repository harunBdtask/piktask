      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="block-block text-center">
            <img src="{{ 'https://piktask.sgp1.digitaloceanspaces.com/images/' . $data->preview }}" class="thumbnail img-responsive">
          </div>

          <a href="{{ 'https://piktask.com/category/-/id='.$data->id }}" target="_blank" class="btn btn-lg btn-success btn-block margin-bottom-10">{{ trans('admin.view') }} <i class="fa fa-external-link-square"></i> </a>
