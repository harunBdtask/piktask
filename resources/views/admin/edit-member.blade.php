       ...
       <div class="row">
        ...
        <div class="col-md-3">
        	...
        	<div class="block-block text-center">
        		<img src="<?php echo !empty($data->avatar)?$data->avatar:url('/public/avatar/default.jpg');?>" class="thumbnail img-responsive">
        	</div>

        	<a href="{{ 'https://piktask.com/author/'.$data->username }}" target="_blank" class="btn btn-lg btn-success btn-block margin-bottom-10">{{ trans('admin.view') }} <i class="fa fa-external-link-square"></i> </a>
