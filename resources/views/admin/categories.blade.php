...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h4>
           {{ trans('admin.admin') }} <i class="fa fa-angle-right margin-separator"></i> {{ trans('misc.categories') }} ({{$data->total()}})
          </h4>
               ...
               <tbody>
                  ...
                  @foreach( $data as $category )
                    <tr>
                      <td>{{ $category->id }}</td>
                      <td>{{ $category->name }}</td>
                      <td><img src="{{ 'https://piktask.sgp1.digitaloceanspaces.com/categories/'.$category->thumbnail }}" width="50" /></td>
                      <td>
