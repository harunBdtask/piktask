              ...
              <div class="small-box bg-aqua">
                ...
                <div class="icon">
                  <i class="ion ion-ios-cart"></i>
								...
								<a href="#" class="small-box-footer">{{trans('misc.view_more')}} <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
        	...
        	<div class="col-md-6">
                  ...
                  <div class="box box-danger">
                      ...
                      <ul class="products-list product-list-in-box">
                        @foreach( $users as $user )
		                      ...
		                      <div class="product-img">
		                        <img src="<?php echo !empty($user->avatar)?$user->avatar:url('/public/avatar/default.jpg');?>" style="height: auto !important;" />
		                      </div>
		                      <div class="product-info">
		                        <a href="{{ 'https://piktask.com/author/'.$user->username }}" target="_blank" class="product-title">@if($user->name !='' ) {{ $user->name }} @else {{ $user->username }} @endif
                    ...
                    <div class="box-footer text-center">
                      <a href="{{ url('panel/admin/members?q=') }}" class="uppercase">{{ trans('admin.view_all_members') }}</a>
                    </div><!-- /.box-footer -->
           ...
           <div class="col-md-6">
             <div class="box box-primary">
              ...
              switch (  $image->status ) {
                    ...
                    <li class="item">
                      <div class="product-img">
                        <img src="{{ 'https://piktask.sgp1.digitaloceanspaces.com/images/' . $image->preview }}" style="height: auto !important;" />
                      </div>
                      <div class="product-info">
                        <a target="_blank" href="{{ 'https://piktask.com/category/-/id='.$image->id }}" class="product-title">{{ $image->title }}
                ...
                <div class="box-footer text-center">
                  <a href="{{ url('panel/admin/images?q=') }}" class="uppercase">{{ trans('admin.view_all_images') }}</a>
                </div><!-- /.box-footer -->
